...
import InventoryTransaction from "./client/InventoryTransaction.js";
import SetBlockProperty from "./client/SetBlockProperty.js";
...
class PacketManager {
    ...
    constructor() {
        ...
        this.serverboundHandlers.set("inventory_transaction", new InventoryTransaction());
        this.serverboundHandlers.set("set_block_property", new SetBlockProperty());
    }
